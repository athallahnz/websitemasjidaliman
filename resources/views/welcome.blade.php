...
@section('content')
    ...
    @if ($nextKajian)
        <div class="container my-5">
            <div class="row justify-content-between align-items-center"
                style="background-color:#a36231; box-shadow: 0 4px 8px rgba(0,0,0,0.2); padding: 20px; border-radius: 10px;">
                ...
                <div class="col-md-5 text-md-end text-center">
                    ...
                    <div id="timer"
                        style="font-size: 4rem; font-weight: 700; color: #fff; border-radius: 5px; display: inline-block;">
                    </div>
                </div>
            </div>
        </div>
    ...
    @else
        <div id="countdown" class="text-center py-4"
            style="background-color:#a36231; box-shadow: 0 4px 8px rgba(0,0,0,0.2); box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
        ...
        <div class="container py-5 px-4 background-color text-white" style="background-color: #622200">
            <div class="row py-2 px-4 bg-transparent">
                <div class="col-12 col-md-4 bg-transparent">
                    <h1 class="fw-bold text-white mx-3">Jadwal Sholat</h1>
                    <h5 class=" my-4 mx-3 text-white"><i class="bi bi-geo-fill text-white"></i> Surabaya,
                        {{ \Carbon\Carbon::now()->format('d F Y') }}</h5>
                </div>
                <div class="col-12 col-md-4 bg-transparent">
        ...
        <div class="row">
            ...
            <div class="col-md-6" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                <div class="p-5 bg-light rounded-3 border">
                    <h4 class="fs-4 pb-4 fw-bold">Daftar Infaq Terbaru</h4>
    ...
    <div id="infaq" class="container-sm mt-5" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="100">
                    ...
                    <div class="row">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <button type="submit" class="btn btn-outline-light"
                                style="background-color: #622200">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="feedback" class="container-sm mt-5">
